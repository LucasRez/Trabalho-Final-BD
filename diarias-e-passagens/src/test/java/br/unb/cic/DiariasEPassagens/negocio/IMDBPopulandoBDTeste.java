...
public class IMDBPopulandoBDTeste extends TestCase {
	...
	public void testePopulaBD() {
		...
		try {
			...
			Genero novoGenero6 = new Genero("Jazz", "Manifesta��o musical originaria de Nova Orleans EUA");
			...
			Genero novoGenero9 = new Genero("Acao", "Adrenalina do come�o ao fim!");
			...
			Autor novoAutor2 = new Autor("Queens of the Stone Age", "Josh Homme revolucionou a forma na qual o rock � feito");
			...
			Autor novoAutor6 = new Autor("Stereophonics", "Banda bastante famosa na Gr�-Bretanha, comandado por Kelly Jones");
			...
			Autor novoAutor10 = new Autor("Adam Sandler", "Sempre pronto para fazer voc� rir");

			Autor novoAutor11 = new Autor("George Lucas", "Lenda do cinema!");

			Autor novoAutor12 = new Autor("Peter Jackson", "Sagrou-se um dos maiores diretores ap�s Senhor dos Aneis");

			Autor novoAutor13 = new Autor("Irm�os Wachowski", "Matrix foi a obra-prima desses diretores");
			...
			Filme novoFilme5 = new Filme("Star Wars V: O Imp�rio Contra-Ataca", 1980, novoGenero13,
			...
			//Avaliacao aval5 = new Avaliacao(5, "Melhor filme de fic�ao cientifica! Porem as sequencias deixam a desejar");
