...
public class IMDBFacadeTest7 extends TestCase {
	...
	public void testeAdicionaAvaliacao(){
		...
		try{
			...
			Autor novoAutor = new Autor("Arnold Schwarzenegger", "Excelente autor e ator de Filmes de A��o");

			Genero novoGenero = new Genero("Hist�ria","Filmes que v�o despertar seu interesse no passado");
